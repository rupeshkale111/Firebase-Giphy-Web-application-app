        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <div className="space-y-6">
            ...
            <div>
              <button
                ...
                className="disabled:opacity-40 flex w-full justify-center rounded-lg bg-blue-500 px-3 py-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
              >
                Sign in
              </button>
            </div>
          ...
          <p className="mt-10 text-center text-sm text-gray-400">
            ...
            <button
              ...
              className="font-semibold leading-6 text-blue-500 hover:text-orange-600"
            >
              Sign Up
            </button>
          </p>
